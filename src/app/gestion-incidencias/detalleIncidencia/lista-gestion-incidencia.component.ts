...
@Component({
  selector: 'app-lista-gestion-incidencia',
  templateUrl: './lista-gestion-incidencia.component.html',
  styleUrls: ['./lista-gestion-incidencia.component.css']
})
export class ListaGestionIncidenciaComponent implements OnInit {
  //Formulario
